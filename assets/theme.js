...
class ProductForm extends HTMLFormElement {
  ...
  onSubmitHandler(event) {
    ...
    fetch(`${theme.routes.cart_add_url}`, config)
      ...
      // custom Upsell adding to cart
       const upsellWrapCheckbox = document.querySelector('input[name="upsell"]');
          if (upsellWrapCheckbox && upsellWrapCheckbox.checked) {
            fetch('/cart/add.js', {
              method: 'POST',
              headers: {
